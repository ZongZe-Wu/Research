...
def main():
    data_path = './'
    emo_path = ['EI-reg-En-anger-train.txt', 'EI-reg-En-fear-train.txt', 'EI-reg-En-joy-train.txt', 'EI-reg-En-sadness-train.txt']
        ...
        with open(data_path+emo) as myfile:
            ...
            if it == 0:
                ...
                for line in myfile:
                    buf = cleansing(line)
                    buf[2] = labeling(buf[2])
                    sadness_data.append([buf[1], buf[2]])
            it += 1
    ...
    print(text.shape)
    print("-----------------------------------------------------")
    np.save('./training_data.npy', text)
    print("training_data.npy saved!!!")
